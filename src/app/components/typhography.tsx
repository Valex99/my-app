...
export const P = createParagraphComponent(
  "leading-[148%] tracking-[0%] font-founders-grotesk font-light text-[18px] lg:text-[18px]",
  "P"
);

export const P2 = createParagraphComponent(
  "leading-[148%] tracking-[0%] font-founders-grotesk font-light text-[16px]",
  "P2"
);

export const P3 = createParagraphComponent(
  "leading-[148%] tracking-[0%] font-founders-grotesk font-light text-[23.5px]",
  "P3"
);
...
export const H1 = createHeadingComponent(
  "h1",
  "text-[35px] lg:text-[60px] leading-[48px] lg:leading-[80px] tracking-[0%] font-romie"
);
export const H2 = createHeadingComponent(
  "h2",
  "text-[27px] font-heading lg:text-[40px]"
);
